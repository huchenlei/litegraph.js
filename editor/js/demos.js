...
// Show value inside the debug console
class TestSpecialNode {

    static title = "Custom Shapes";
...
// Show value inside the debug console
class LargeInputNode {

    static title = "Large Input Node";
